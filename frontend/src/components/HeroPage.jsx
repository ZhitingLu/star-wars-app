      ...
      <div className="relative isolate overflow-hidden pt-14">
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              ...
              <p className="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">
                Discover characters, learn about planets, and dive deep into the
                Star Wars universe with data pulled from the SWAPI.
              </p>
        ...
        >
          <div
            ...
            className="relative left-[calc(50%+3rem)] aspect-1155/678 w-144.5 -translate-x-1/2 bg-gradient-to-tr from-[#351c26] to-[#9089fc] opacity-10 sm:left-[calc(50%+36rem)] sm:w-288.75"
          />
        </div>
      </div>
    </div>
